...
contract PuppyRaffle is ERC721, Ownable {
    ...
    function enterRaffle(address[] memory newPlayers) public payable {
        ...
        // @followup/audit I fits and empty array, we still emit an event?
    ...
    function getActivePlayerIndex(address player) external view returns (uint256) {
        ...
        // @audit if the player is at index 0, it'll return 0 and a player might think they aren't active!
        return 0;
    }
    ...
    function selectWinner() external {
        ...
        // @audit the winner woudn't get the money if their fallback was messed up!
    ...
    function withdrawFees() external {
        // @audit is it difficult to withdraw fees if their are players (MEV)
